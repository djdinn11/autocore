...
bool Spotify::check_timerate() {
    ...
    if (current_time < start_timestamp) {
        ...
        return true; // Force refresh in case of time manipulation
    }
    int time_diff_seconds = current_time - start_timestamp;
    int time_diff_minutes = time_diff_seconds / 60;
    return time_diff_minutes >= timerate;
}
/**
